...
- **Phase 8 — final QA pass.** Pagefind runtime (Slice 1) + CI gates trio (Slice 2) are shipped; only the manual keyboard / SR / CB / mobile audit checklist remains (Slice 3).
