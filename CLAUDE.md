...
- **Layouts**:
  ...
  - `layouts/research/list.html` — `/research/` index (theme cards grid + tag filter chips + ⊞ Graph toggle; panel + JSON blob emitted here).
