...
| # | Item | Source |
|---|---|---|
| 8.1 | ✓ **Sub-project E — explorable explainables** (Phase 3 final piece). Per-page interactive widgets + per-page JS bundle convention. Shipped 2026-06-12 (site commits TBD-FILL-AFTER-MERGE). 28th linter pair (6 rules) + CSS §49 + 13th JS bundle (per-essay dynamic loop) + 2 library kinds (ReactiveValue, ReactiveChart) + runtime + shortcode upgrade + 1 fixture + example-one migration. → [project-tier-8-1-complete](../../../.claude/memory/project_tier_8_1_complete.md) | `docs/superpowers/specs/2026-06-12-sub-project-e-explorables-design.md` + `docs/superpowers/plans/2026-06-12-sub-project-e-explorables.md` |
