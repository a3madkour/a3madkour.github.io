...
**Date:** 2026-07-03
**Status:** Active. **Tier R1 closed** (`8ba3882..2422e81`, 3 commits) + **Tier R2 closed** (`d09d531..f5962ac`, 6 commits), both 2026-07-03. R4.3 (dead-CSS purge) shipped with R2.3. Tier R3 is the next queue head. Remaining rows ☐ open; tiers run in numbered order.
